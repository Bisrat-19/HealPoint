...
import { useTodayAppointments, useTodayTotalAmount } from '@/hooks/useDashboardData';
...
const AdminDashboard = () => {
  ...
  if (isLoadingUsers || isLoadingPatients || isLoadingAppointments || isLoadingTodayTotal) {
    return (
